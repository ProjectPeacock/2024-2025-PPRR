...
public final class TwoDeadWheelLocalizer implements Localizer {
    public static class Params {
        public double parYTicks = 2602.0981954302238; // y position of the parallel encoder (in tick units)
        public double perpXTicks = -2447.6149366974414; // x position of the perpendicular encoder (in tick units)
    }
